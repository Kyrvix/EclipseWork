...
//		Tile treasure = new Tile(7,4);
//		Tile person = new Tile(0,0);
		...
		for (int i = 1; i > 0; i++) {
			...
			if (dist > 5) {
				...
				i = -1;
				System.out.println(
						"You reach the chest. I"
						+ "nside, you find treasure and a map to escape inside. Congratulations, you win!... For now.");
			}
		}
	}
}
